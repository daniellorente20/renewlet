...
const subscriptionBackfillRowSchema = z.object({
  ...
  extra_json: z.string(),
  previous_price: z.string().nullable().default(null),
  previous_price_currency: z.string().nullable().default(null),
  previous_price_changed_at: z.string().nullable().default(null),
  created_at: z.string(),
  updated_at: z.string(),
